...
- **No subcommands.** `rite <positional>` is always a task name; non-task invocations are flags. This principle cost us a same-day revert in 1.0 (#83). Don't re-propose without raising it for discussion first.
